...
// Gmail logo SVG for use in buttons
export default function GmailLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 268.1522 273.8827" height={40} width={40} overflow="hidden" >
  <defs>
    <linearGradient id="a">
